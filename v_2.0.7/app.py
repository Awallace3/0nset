...
def uploaded_file(filename):
    ...
    with open(filename) as search:
        for num, line in enumerate(search,1):
            ...
            """ for (one, two) in zip(line[0::2], line[1::2]):
                print(one+two)
                if (one+two) == ",,":
                    print("yes") """
    ...
    try:
        ...
        final_x_value_1, line_formula1, x_flat_1, new_y_flat_1, xs_1, ys_1, arr_x_1, arr_y_1, test_1, rms_1, max_y_1 = None, None, None, None, None, None, None, None, None, None, None
        image_1 = None
        image_2 = None
