...
def uploaded_file(filename):
    ...
    def steepest_line_input(ind, array_xy, array_x, array_y, neb, x_direction, y_norm_not=y_norm_not, poly_fit=poly_fit):
        ...
        if x_direction == "increasing":
            ...
            z_1 = np.polyfit(x_flat_1, y_flat_1, poly_fit)  # 3rd degree helps with overfitting datasets
            p = np.poly1d(z_1)
            ...
            return slope, y_1_intercept, int_row_max_2, end_2, rms, test1, int_b_val, start_end, highest
    ...
    def absorption_onset(input_array_x, input_array_y, text1, text2, x_direction, y_norm_not=y_norm_not, poly_fit=poly_fit):
        ...
        for i in range(len(array_y)):
            if i > len(array_y) - 11:
                ...
                simple_moving_average = ( array_y[i] + array_y[i+1] + array_y[i+2] + 
                array_y[i+3] + array_y[i+4] + array_y[i + 5] + array_y[i + 6] + 
                array_y[i+7] + array_y[i+8] + array_y[i + 9] + array_y[i + 10] )/ 10
        ...
        for i in range(size):
            ...
            slope_t, y_intercept_t, int_row_max_t, end_t, rms_t, test1, int_b_val_t, start_end, highest_t = steepest_line_input(i, array_xy, array_x, array_y, neb, x_direction)
            print("Line" + str(i+1) + "   ", "Slope:", slope_t, " Intercept:", y_intercept_t, " Interval:", test1)
        ...
        return final_x_value, line_formula, x_flat_1, new_y_flat, xs_4, ys_4, array_x, array_y, test1, rms, max_y_4, scaling, max_xs_ls, min_xs_ls
    ...
    if num_trials >= 2:
        ...
        array_2 = np.column_stack((trials_dict['col_3'], trials_dict['col_4']))
    ...
    if num_trials >= 3:
        ...
        array_3 = np.column_stack((trials_dict['col_5'], trials_dict['col_6']))
    ...
    if num_trials >= 4:
        ...
        array_4 = np.column_stack((trials_dict['col_7'], trials_dict['col_8']))
    ...
    try:
        final_x_value_1, line_formula1, x_flat_1, new_y_flat_1, xs_1, ys_1, arr_x_1, arr_y_1, test_1, rms_1, max_y_1, scaling_1, max_xs_ls_1, min_xs_ls_1 = absorption_onset(t1_x_f, t1_y_f, text1, text2, x_direction)
        ...
        try:
            final_x_value_1, line_formula1, x_flat_1, new_y_flat_1, xs_1, ys_1, arr_x_1, arr_y_1, test_1, rms_1, max_y_1, scaling_1, max_xs_ls_1, min_xs_ls_1 = None, None, None, None, None, None, None, None, None, None, None, None, None, None
            image_1 = matplotlib_make_plot("Figure 1", t1_x_f, t1_y_f, None, None, None)
            image_2 = None
    ...
    try:
        final_x_value_2, line_formula2, x_flat_2, new_y_flat_2, xs_2, ys_2, arr_x_2, arr_y_2, test_2, rms_2, max_y_2, scaling_2, max_xs_ls_2, min_xs_ls_2 = absorption_onset(t2_x_f, t2_y_f, text1, text2, x_direction)
        ...
        try:
            final_x_value_2, line_formula2, x_flat_2, new_y_flat_2, xs_2, ys_2, arr_x_2, arr_y_2, test_2, rms_2, max_y_2, scaling_2, max_xs_ls_2, min_xs_ls_2 = None, None, None, None, None, None, None, None, None, None, None, None, None, None
            image_3 = matplotlib_make_plot("Figure 2", t2_x_f, t2_y_f, None, None, None)
            image_4 = None
    ...
    try:
        final_x_value_3, line_formula3, x_flat_3, new_y_flat_3, xs_3, ys_3, arr_x_3, arr_y_3, test_3, rms_3, max_y_3, scaling_3, max_xs_ls_3, min_xs_ls_3 = absorption_onset(t3_x_f, t3_y_f, text1, text2, x_direction)
        ...
        try:
            final_x_value_3, line_formula3, x_flat_3, new_y_flat_3, xs_3, ys_3, arr_x_3, arr_y_3, test_3, rms_3, max_y_3, scaling_3, max_xs_ls_3, min_xs_ls_3  =None, None, None, None, None, None, None, None, None, None, None, None, None, None
            image_5 = matplotlib_make_plot("Figure 2", t3_x_f, t3_y_f, None, None, None)
            image_6 = None
    ...
    try:
        ...
        final_x_value_4, line_formula4, x_flat_4, new_y_flat_4, xs_4, ys_4, arr_x_4, arr_y_4, test_4, rms_4, max_y_4, scaling_4, max_xs_ls_4, min_xs_ls_4 = absorption_onset(t4_x_f, t4_y_f, text1, text2, x_direction)
        ...
        try:
            final_x_value_4, line_formula4, x_flat_4, new_y_flat_4, xs_4, ys_4, arr_x_4, arr_y_4, test_4, rms_4, max_y_4, scaling_4, max_xs_ls_4, min_xs_ls_4  = None, None, None, None, None, None, None, None, None, None, None, None, None, None
            image_7 = matplotlib_make_plot("Figure 2", t4_x_f, t4_y_f, None, None, None)
            image_8 = None
    ...
    return render_template("final_x.html", x_direction=x_direction, 
                            plot_filename=plot_filename, x_range_out_1=x_range_out_1, x_range_out_2=x_range_out_2,
                             ...
                             max_xs_ls_1=max_xs_ls_1, min_xs_ls_1=min_xs_ls_1,
                             max_xs_ls_2=max_xs_ls_2, min_xs_ls_2=min_xs_ls_2,
                             max_xs_ls_3=max_xs_ls_3, min_xs_ls_3=min_xs_ls_3,
                             max_xs_ls_4=max_xs_ls_4, min_xs_ls_4=min_xs_ls_4,
